...
import { navLinks, siteConfig, whatsappLink, defaultWhatsappMessage } from "@/lib/site-config";
      ...
      <Container className="relative py-16">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <FooterColumn title="Catering">
            <FooterLink href="/catering">Disposable Tray Catering</FooterLink>
            <FooterLink href="/catering">Complete Buffet Setup</FooterLink>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-cream-100/10 pt-8 text-xs text-cream-200/60 sm:flex-row">
          ...
          <p>Authentic Pakistani catering serving {siteConfig.serviceAreas.join(", ")}.</p>
        </div>
      </Container>
    </footer>
  );
